...
import { speak, hasArabic } from '../utils/speech';
  ...
  return (
    <div className="gp">
      ...
      <div className="gp-content">
        ...
        {/* Texte arabe + bouton écoute */}
        <div className="gp-arabic-row">
          <div className="gp-arabic">{step.arabic}</div>
          {hasArabic(step.arabic) && (
            <button className="speak-btn" onClick={() => speak(step.arabic)}>🔊</button>
          )}
        </div>
